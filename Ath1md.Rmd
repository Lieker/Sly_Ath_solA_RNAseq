...
## GO annotation with AgriGO

The 'genes' column from the files that were created in the Annotation of DEGs section, were run in AgriGO (http://bioinfo.cau.edu.cn/agriGO/analysis.php), with the following settings: SEA, Arabidopsis thaliana, TAIR9, default settings.
The results were saved as Ath1/output/GOann-agriGO_[conc_of_treatment]_[tp].csv.
