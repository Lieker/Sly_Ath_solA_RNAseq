...
```{r message=FALSE, warning=FALSE}
n2 <- n2 %>% rownames_to_column("gene")
n24 <- n24 %>% rownames_to_column("gene")
inner_join(n2, n24, by = "gene")
```

Only 54 genes overlap between these timepoints. This means that a nanomolar solanoeclepin A treatment induces mostly timepoint-specific transcriptional changes.
