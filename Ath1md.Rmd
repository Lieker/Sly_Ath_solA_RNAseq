...
make_volcanoplot(trtm = c("ethanol", "nanomolar_solanoeclepinA"), treatment2 = "nanomolar_solanoeclepinA", tp = 2, method = "treatment", FCcutoff_volcano = 1, padj_threshold = 0.01, ttl = "DEGs at t = 2h, uM solA, Wald test")
```

Then for time point = 6h:
```{r}
make_volcanoplot(tp = 6, method = "treatment", FCcutoff_volcano = 1, padj_threshold = 0.05, ttl = "DEGs at t = 6h, uM solA, Wald test")
make_volcanoplot(trtm = c("ethanol", "nanomolar_solanoeclepinA"), treatment2 = "nanomolar_solanoeclepinA", tp = 6, method = "treatment", FCcutoff_volcano = 1, padj_threshold = 0.05, ttl = "DEGs at t = 6h, nM solA, Wald test")
```

Then for time point = 24h:
```{r}
make_volcanoplot(tp = 24, method = "treatment", FCcutoff_volcano = 1, padj_threshold = 0.05, ttl = "DEGs at t = 24h, uM solA, Wald test")
make_volcanoplot(trtm = c("ethanol", "nanomolar_solanoeclepinA"), treatment2 = "nanomolar_solanoeclepinA", tp = 24, method = "treatment", FCcutoff_volcano = 1, padj_threshold = 0.05, ttl = "DEGs at t = 24h, nM solA, Wald test")
```
...
```{r message=FALSE, warning=FALSE}
compare_wald_vs_LRT(trtm = c("ethanol", "nanomolar_solanoeclepinA"),
...
t=2h
```{r message=FALSE, warning=FALSE}
compare_wald_vs_LRT(tp = 2, method = "treatment")
compare_wald_vs_LRT(tp = 2, method = "treatment", trtm = c("ethanol", "nanomolar_solanoeclepinA"),
                    treatment2 = "nanomolar_solanoeclepinA")
...
Then for t=6h
```{r message=FALSE, warning=FALSE}
compare_wald_vs_LRT(tp = 6, method = "treatment")
compare_wald_vs_LRT(tp = 6, method = "treatment", trtm = c("ethanol", "nanomolar_solanoeclepinA"),
                    treatment2 = "nanomolar_solanoeclepinA")
```

And for t = 24h:
```{r message=FALSE, warning=FALSE}
compare_wald_vs_LRT(tp = 24, method = "treatment")
compare_wald_vs_LRT(tp = 24, method = "treatment", trtm = c("ethanol", "nanomolar_solanoeclepinA"),
                    treatment2 = "nanomolar_solanoeclepinA")
```
