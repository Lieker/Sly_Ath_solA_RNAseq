...
p1 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root", "shoot"), pca_colour = "treatment")
p2 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root", "shoot"), pca_colour = "compartment")
p1 + p2
```

On PC1, the compartments cluster together. There is no clear clustering based on solA treatment. Let's check PC3 and PC4.
```{r}
p1 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root", "shoot"), pc_x_axis = "PC3", pc_y_axis = "PC4", pca_colour = "treatment")
p2 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root", "shoot"), pc_x_axis = "PC3", pc_y_axis = "PC4", pca_colour = "compartment")
p1 + p2
```
...
plot_scree(count_csv_file = "Sly1/input/counts_multi.csv", comp = c("root","shoot"))
```

It would be more informative to look at the compartments individually.
```{r}
p1 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("shoot"), pc_x_axis = "PC1", pc_y_axis = "PC2", pca_colour = "treatment") + ggtitle("shoot")
p2 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root"), pc_x_axis = "PC1", pc_y_axis = "PC2", pca_colour = "treatment") + ggtitle("root")
p3 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("shoot"), pc_x_axis = "PC3", pc_y_axis = "PC4", pca_colour = "treatment") +ggtitle("shoot")
p4 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root"), pc_x_axis = "PC3", pc_y_axis = "PC4", pca_colour = "treatment") + ggtitle("root")
(p1 + p2) / (p3 + p4)
```
```{r}
p1 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("shoot"), pc_x_axis = "PC5", pc_y_axis = "PC6", pca_colour = "treatment") + ggtitle("shoot")
p2 <- plot_pca(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root"), pc_x_axis = "PC5", pc_y_axis = "PC6", pca_colour = "treatment") + ggtitle("root")
p1 + p2
```
...
```{r}
p1 <- plot_scree(count_csv_file = "Sly1/input/counts_multi.csv", comp = "shoot") + ggtitle("Shoot")
p2 <- plot_scree(count_csv_file = "Sly1/input/counts_multi.csv", comp = "root") + ggtitle("Root")
p1 + p2
```
##PLS-DA analysis
...
do_plsda_perf(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root","shoot"), n = 99) #this takes some time
```
...
do_plsda(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root","shoot"), nc = 2, ttl = "All tomato samples PLS-DA")
```
...
```{r}
do_plsda_perf(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "shoot", n = 99)
do_plsda(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "shoot", nc = 2, ttl = "Shoot samples PLS-DA")

do_plsda_perf(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "root", n = 99)
do_plsda(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "root", nc = 4, ttl = "Root samples PLS-DA")
...
make_volcanoplot(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root","shoot"), log2FC_threshold = 0, FCcutoff_volcano = 1, padj_threshold = 0.05, ttl = "All treatments, solA treatment, Wald", method = "compartment+treatment")
```
...
```{r, warning = FALSE, message = FALSE}
make_volcanoplot(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("shoot"), log2FC_threshold = 0, FCcutoff_volcano = 1, padj_threshold = 0.05, ttl = "Shoot, solA treatment, Wald", method = "treatment")
make_volcanoplot(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = c("root"), log2FC_threshold = 0, FCcutoff_volcano = 1, padj_threshold = 0.05, ttl = "Root, solA treatment, Wald", method = "treatment")
```
...
xs <- get_list_of_DEGs(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "shoot", method = "treatment", log2FC_threshold = 0)
xs <- xs %>% rownames_to_column("genes")
xr <- get_list_of_DEGs(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "root", method = "treatment", log2FC_threshold = 0)
xr <- xr %>% rownames_to_column("genes")
x <- rbind(xs, xr)
source("Sly1/scripts/produce_scaled_counts_matrix.R")
y <- produce_scaled_counts_matrix(count_csv_file = "Sly1/input/counts_multi.csv") %>% column_to_rownames("sample") %>% t() %>% as.data.frame() %>% rownames_to_column("genes")
DEG_counts <- left_join(x, y, by="genes") 
DEG_counts <- DEG_counts[, -c(2,3,4,5,6,7)]
DEG_counts <- DEG_counts[!duplicated(DEG_counts$genes),]
row.names(DEG_counts) <- NULL
...
```{r message=FALSE, warning=FALSE}
x <- get_list_of_DEGs(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "root", method = "treatment", log2FC_threshold = 0)
x <- x %>% rownames_to_column("genes")

y <- filter_counts_based_on_compartment(count_csv_file = "Sly1/input/counts_multi.csv", comprtmt = "root") %>% t() %>% as.data.frame() %>% rownames_to_column("genes")
DEG_counts <- left_join(x, y, by="genes") 
DEG_counts <- DEG_counts[, -c(2,3,4,5,6,7)]
DEG_counts <- DEG_counts[!duplicated(DEG_counts$genes),]
DEG_counts <- DEG_counts %>% column_to_rownames("genes")
...
compare_wald_vs_LRT(count_csv_file = "Sly1/input/counts_multi.csv", compartment = c("root","shoot"), method = "compartment+treatment")
```
...
```{r}
compare_wald_vs_LRT(count_csv_file = "Sly1/input/counts_multi.csv", compartment = "root", method = "treatment")

compare_wald_vs_LRT(count_csv_file = "Sly1/input/counts_multi.csv", compartment = "shoot", method = "treatment")
```
...
gg <- get_annotated_DEGs(count_csv_file = "Sly1/input/counts_multi.csv", plantpart = "root", method = "treatment")
```