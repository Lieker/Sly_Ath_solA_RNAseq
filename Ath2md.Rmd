...
colnames(b) <- c("Ath_Pstarv+solA","Ath_NPstarv+solA","Ath_replete+solA","Sly_root+solA","Sly_shoot+solA")
...
all_Ath_genes <- unique(unlist(list(Pstarv_nosolA$Group.1, NPstarv_nosolA$Group.1, Nstarv_nosolA$Group.1)))
all_Ath_genes <- str_subset(all_Ath_genes, "AT*")
Pns <- all_Ath_genes %in% Pstarv_nosolA$Group.1
NPns <- all_Ath_genes %in% NPstarv_nosolA$Group.1
Nns <- all_Ath_genes %in% Nstarv_nosolA$Group.1
